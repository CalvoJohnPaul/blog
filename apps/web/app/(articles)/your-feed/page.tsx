  ...
  const postsQuery = usePostsQuery(
    {
      page,
      pageSize,
      userId__in: meQuery.data?.following,
    },
    {
      enabled: meQuery.data != null && meQuery.data.following.length > 0,
    },
  );
          ...
          <div className="flex items-start">
            ...
            <button
              ...
              onClick={async () => {
                if (post.favourite) {
                  ...
                  queryClient.setQueriesData<Paginated<Post>>(
                    {
            ...
            >
              <HeartIcon
                className={clsx(
                  'size-3',
                  post.favourite ? 'stroke-emerald-400 fill-emerald-400' : 'stroke-emerald-400',
                )}
              />
