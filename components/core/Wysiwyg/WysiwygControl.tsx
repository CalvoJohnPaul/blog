...
export const Control = forwardRef<HTMLDivElement, WysiwygControlProps>((props, ref) => {
  const wysiwyg = useWysiwygContext();

  const mergedProps = useMemo(() => mergeProps(wysiwyg.getControlProps(), props), [props, wysiwyg]);
