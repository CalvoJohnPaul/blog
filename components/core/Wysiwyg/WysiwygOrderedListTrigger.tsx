...
export interface WysiwygOrderedListTriggerProps extends HTMLArkProps<'button'> {}

export const OrderedListTrigger = forwardRef<HTMLButtonElement, WysiwygOrderedListTriggerProps>(
  (props, ref) => {
